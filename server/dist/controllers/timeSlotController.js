...
const getAll = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield timeslot_1.default.find().sort({ day: 1, slotNumber: 1 });
    res.json({ success: true, data });
});
exports.getAll = getAll;
const create = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const doc = yield timeslot_1.default.create(req.body);
    res.status(201).json({ success: true, data: doc });
});
exports.create = create;
const update = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const doc = yield timeslot_1.default.findByIdAndUpdate(req.params.id, req.body, { new: true });
    if (!doc)
...
const remove = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield timeslot_1.default.findByIdAndDelete(req.params.id);
...
const importCSV = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const docs = yield timeslot_1.default.insertMany(rows);
